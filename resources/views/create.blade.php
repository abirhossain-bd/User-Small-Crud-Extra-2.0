		...
		<div class="row">
			<div class="panel panel-primary">
				<div class="panel-body ">
					<form method="POST" action="{{ url('user/create_post') }}" role="form" enctype="multipart/form-data">
                        @csrf
						...
						<div class="form-group">
							<button id="signupSubmit" type="submit" class="btn btn-info btn-block">Create user account</button>
						</div>
